...
\usepackage[total={7.35in, 10.5in}]{geometry}
\usepackage{hyperref}
\usepackage{setspace}
\usepackage{titlesec}
\usepackage{enumitem}
...
% remove extra subsection spacing
\titlespacing*{\subsection}{0pt}{2pt}{0pt}
% remove extra list spacing
\setitemize{noitemsep, nosep, topsep=0pt,parsep=0pt,partopsep=0pt, itemsep=0pt}
% set subsection font size
...
\subsection*{MarkedUp \normalfont{\textit{\href{https://github.com/ridvikpal/MarkedUp}{\underline{(github.com/ridvikpal/MarkedUp)}}}}}
\vspace*{2pt}
...
\subsection*{CarCartAPI \normalfont{\textit{\href{https://github.com/ridvikpal/CarCartAPI}{\underline{(github.com/ridvikpal/CarCartAPI)}}}}}
\vspace*{2pt}
...
\subsection*{RainyDay \normalfont{\textit{\href{https://github.com/ridvikpal/RainyDay}{\underline{(github.com/ridvikpal/RainyDay)}}}}}
\vspace*{2pt}
...
\subsection*{SimplyTrack \normalfont{\textit{\href{https://github.com/ridvikpal/SimplyTrack}{\underline{(github.com/ridvikpal/SimplyTrack)}}}}}
\vspace*{2pt}
